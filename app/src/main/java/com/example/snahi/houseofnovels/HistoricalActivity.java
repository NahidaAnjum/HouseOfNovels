...
public class HistoricalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.historicalfiction_ttl));
    ...
    public class RrbAsynctask extends AsyncTask<String, Void, String> {
        ...
        String Myurl = getString(R.string.historicalfiction_url);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Toast.makeText(HistoricalActivity.this, "" + i, Toast.LENGTH_SHORT).show();
        ...
        private void runLayoutAnimation(final RecyclerView recyclerView) {
            ...
            recyclerView.setAdapter(new AdapterClass(HistoricalActivity.this, list));
            recyclerView.setLayoutManager(new LinearLayoutManager(HistoricalActivity.this));
