...
public class FantasyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RrbAsynctask rrbAsynctask = new RrbAsynctask();
        rrbAsynctask.execute();
        this.setTitle(getString(R.string.fantasyttl));
    ...
    public class RrbAsynctask extends AsyncTask<String, Void, String> {
        ...
        String Myurl = getString(R.string.fantasy_url);
        ...
        protected void onPostExecute(String s) {
            ...
            list = new ArrayList<>();
            //Toast.makeText(FantasyActivity.this, "" + s, Toast.LENGTH_SHORT).show();
            try {
        ...
        private void runLayoutAnimation(final RecyclerView recyclerView) {
            ...
            recyclerView.setAdapter(new AdapterClass(FantasyActivity.this, list));
            recyclerView.setLayoutManager(new LinearLayoutManager(FantasyActivity.this));
