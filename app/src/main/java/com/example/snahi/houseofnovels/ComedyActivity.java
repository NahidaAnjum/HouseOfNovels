...
public class ComedyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ComedyAsynctask().execute();
        this.setTitle(getString(R.string.comedyttl));
        CollapsingToolbarLayout ctl = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        ctl.setTitle(getString(R.string.tittle_toolbar));
    }

    public class ComedyAsynctask extends AsyncTask<String, Void, String> {

        String Myurl = getString(R.string.comedy_url);
        ...
        protected void onPostExecute(String s) {
            ...
            list = new ArrayList<>();
           // Toast.makeText(ComedyActivity.this, "" + s, Toast.LENGTH_SHORT).show();
            try {
                ...
                for (i = 0; i < jsonArray.length(); i++) {
                    ...
                    String othr = vlminfo.optString("authors");
                    ...
                    BookModel bookmodel = new BookModel(id, title, othr, pulisher, pulisherdate, imagelink, price, desc);
                    list.add(bookmodel);
                }
        ...
        private void runLayoutAnimation(final RecyclerView recyclerView) {
            ...
            recyclerView.setAdapter(new AdapterClass(ComedyActivity.this, list));
            recyclerView.setLayoutManager(new LinearLayoutManager(ComedyActivity.this));
