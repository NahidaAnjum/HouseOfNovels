...
public class DramaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.dramattl));
    ...
    public class RrbAsynctask extends AsyncTask<String, Void, String> {
        ...
        String Myurl = getString(R.string.drama_url);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                Toast.makeText(DramaActivity.this, "" + i, Toast.LENGTH_SHORT).show();
        ...
        private void runLayoutAnimation(final RecyclerView recyclerView) {
            ...
            recyclerView.setAdapter(new AdapterClass(DramaActivity.this, list));
            recyclerView.setLayoutManager(new LinearLayoutManager(DramaActivity.this));
