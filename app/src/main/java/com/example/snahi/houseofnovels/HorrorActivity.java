...
public class HorrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.horror_ttl));
    ...
    public class RrbAsynctask extends AsyncTask<String, Void, String> {
        ...
        String Myurl = getString(R.string.horror_url);
        ...
        private void runLayoutAnimation(final RecyclerView recyclerView) {
            ...
            recyclerView.setAdapter(new AdapterClass(HorrorActivity.this, list));
            recyclerView.setLayoutManager(new LinearLayoutManager(HorrorActivity.this));
